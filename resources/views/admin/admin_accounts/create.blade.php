...
<div class="space-y-6">
    <div>
        ...
        <div class="mt-3">
            ...
            <p class="mt-1 text-sm text-gray-500">Buat akses login khusus administrator.</p>
        </div>
    </div>
    ...
    <section class="overflow-hidden rounded-md border border-gray-200 bg-white shadow-sm">
        ...
        <form method="POST" action="{{ route('admin.settings.admin_accounts.store') }}" class="space-y-5 p-6">
            @csrf
            <div class="grid gap-4 md:grid-cols-2">
                <div>
                    <label class="mb-2 block text-sm font-semibold text-gray-700">Nama</label>
                    <input name="name" value="{{ old('name') }}" class="h-11 w-full rounded-md border border-gray-200 px-3 text-sm text-gray-700 outline-none transition focus:border-blue-500 focus:ring-4 focus:ring-blue-100">
                ...
                <div>
                    ...
                    <input name="username" value="{{ old('username') }}" placeholder="Contoh: admin_hrd" class="h-11 w-full rounded-md border border-gray-200 px-3 text-sm text-gray-700 outline-none transition focus:border-blue-500 focus:ring-4 focus:ring-blue-100">
                ...
                <div>
                    ...
                    <input type="email" name="email" value="{{ old('email') }}" class="h-11 w-full rounded-md border border-gray-200 px-3 text-sm text-gray-700 outline-none transition focus:border-blue-500 focus:ring-4 focus:ring-blue-100">
                ...
                <div>
                    ...
                    <input type="password" name="password" class="h-11 w-full rounded-md border border-gray-200 px-3 text-sm text-gray-700 outline-none transition focus:border-blue-500 focus:ring-4 focus:ring-blue-100">
