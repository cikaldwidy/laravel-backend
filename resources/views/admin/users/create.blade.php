...
<div class="bg-white p-6 rounded-xl shadow max-w-xl mx-auto">
    <div class="flex items-start justify-between gap-3 mb-5">
        <div>
            ...
            <p class="text-sm text-gray-500">Buat akses login khusus pegawai.</p>
        </div>
    ...
    <form method="POST" action="{{ route('admin.users.store') }}" class="space-y-4">
        ...
        <div>
            ...
            <input name="username" value="{{ old('username') }}" class="w-full p-2 border rounded mt-1" placeholder="Contoh: budi_santoso">
