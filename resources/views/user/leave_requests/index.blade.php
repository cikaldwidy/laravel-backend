...
<div class="user-page">
    <div class="user-phone">
        @include('user.partials.header', [
            ...
            'action' => new \Illuminate\Support\HtmlString('<a href="' . route('leave_requests.create') . '" class="user-header-icon text-blue-700 bg-white/80 border border-white/60 shadow-sm"><i class="fa-solid fa-plus"></i></a>'),
        ])
