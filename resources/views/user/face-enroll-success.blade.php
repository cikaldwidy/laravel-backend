...
<div class="min-h-screen bg-[#f8fbff]">
    ...
    <div class="px-4 md:px-14 lg:px-20 pb-10">
        <div class="max-w-5xl mx-auto bg-white rounded-md shadow-lg p-6 md:p-10">
            <div class="flex flex-col items-center text-center py-6">
                <div class="relative w-28 h-28 rounded-full border-4 border-green-500 flex items-center justify-center">
                    ...
                    <span class="absolute -top-1 right-2 w-2 h-2 rounded-full bg-blue-400"></span>
                ...
                <a href="{{ route('dashboard') }}" class="mt-8 inline-flex items-center gap-3 bg-blue-600 hover:bg-blue-700 text-white text-sm font-semibold px-8 py-3 rounded-md shadow transition">
                    LANJUTKAN KE DASHBOARD
                    <span class="w-6 h-6 rounded-full bg-white text-blue-600 flex items-center justify-center">
